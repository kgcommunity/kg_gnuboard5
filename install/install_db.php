...
$site_service  = $_POST['site_service'];
...
<div class="ins_inner">
    <h2><?php echo $site_name ?> 설치가 시작되었습니다.</h2>
...
$write_prefix = $table_prefix.'write_';
for($i = 1; $i < 8 ; $i++) {

    // 그룹등록
    sql_query(" insert into `{$table_prefix}group` set gr_id = 'group{$i}0', gr_subject = '그룹{$i}0' ", true, $dblink);

    for($j = 1; $j < 6 ; $j++) {

        //소게시판등록
        sql_query(" insert into `{$table_prefix}board` set bo_table = 'board{$i}0{$j}0', bo_count_write = '0', bo_count_comment = '0', gr_id = 'group{$i}0', bo_subject = '보드{$i}0{$j}0', bo_mobile_subject = '', bo_device = 'both', bo_admin = '', bo_list_level = '1', bo_read_level = '1', bo_write_level = '1', bo_reply_level = '1', bo_comment_level = '1', bo_html_level = '1', bo_link_level = '1', bo_count_modify = '1', bo_count_delete = '1', bo_upload_level = '1', bo_download_level = '1', bo_read_point = '0', bo_write_point = '0', bo_comment_point = '0', bo_download_point = '0', bo_use_category = '', bo_category_list = '', bo_use_sideview = '', bo_use_file_content = '', bo_use_secret = '0', bo_use_dhtml_editor = '', bo_use_rss_view = '', bo_use_good = '', bo_use_nogood = '', bo_use_name = '', bo_use_signature = '', bo_use_ip_view = '', bo_use_list_view = '', bo_use_list_file = '', bo_use_list_content = '', bo_use_email = '', bo_use_cert = '', bo_use_sns = '', bo_table_width = '100', bo_subject_len = '60', bo_mobile_subject_len = '30', bo_page_rows = '15', bo_mobile_page_rows = '15', bo_new = '24', bo_hot = '100', bo_image_width = '600', bo_skin = 'basic', bo_mobile_skin = 'basic', bo_include_head = '_head.php', bo_include_tail = '_tail.php', bo_content_head = '', bo_content_tail = '', bo_mobile_content_head = '', bo_mobile_content_tail = '', bo_insert_content = '', bo_gallery_cols = '4', bo_gallery_width = '174', bo_gallery_height = '124', bo_mobile_gallery_width = '125', bo_mobile_gallery_height= '100', bo_upload_count = '2', bo_upload_size = '1048576', bo_reply_order = '1', bo_use_search = '1', bo_order = '', bo_write_min = '', bo_write_max = '', bo_comment_min = '', bo_comment_max = '', bo_sort_field = '', bo_1_subj = '', bo_2_subj = '', bo_3_subj = '', bo_4_subj = '', bo_5_subj = '', bo_6_subj = '', bo_7_subj = '', bo_8_subj = '', bo_9_subj = '', bo_10_subj = '', bo_1 = '', bo_2 = '', bo_3 = '', bo_4 = '', bo_5 = '', bo_6 = '', bo_7 = '', bo_8 = '', bo_9 = '', bo_10 = '' ", true, $dblink);

        // 게시판 테이블 생성
        $file = file('../adm/sql_write.sql');
        $sql = implode($file, "\n");

        $create_table = $write_prefix . "board{$i}0{$j}0";
        ...
        //소갤러리등록
        sql_query(" insert into `{$table_prefix}board` set bo_table = 'gallery{$i}0{$j}0', bo_count_write = '0', bo_count_comment = '0', gr_id = 'group{$i}0', bo_subject = '갤러리{$i}0{$j}0', bo_mobile_subject = '', bo_device = 'both', bo_admin = '', bo_list_level = '1', bo_read_level = '1', bo_write_level = '1', bo_reply_level = '1', bo_comment_level = '1', bo_html_level = '1', bo_link_level = '1', bo_count_modify = '1', bo_count_delete = '1', bo_upload_level = '1', bo_download_level = '1', bo_read_point = '0', bo_write_point = '0', bo_comment_point = '0', bo_download_point = '0', bo_use_category = '', bo_category_list = '', bo_use_sideview = '', bo_use_file_content = '', bo_use_secret = '0', bo_use_dhtml_editor = '', bo_use_rss_view = '', bo_use_good = '', bo_use_nogood = '', bo_use_name = '', bo_use_signature = '', bo_use_ip_view = '', bo_use_list_view = '', bo_use_list_file = '', bo_use_list_content = '', bo_use_email = '', bo_use_cert = '', bo_use_sns = '', bo_table_width = '100', bo_subject_len = '60', bo_mobile_subject_len = '30', bo_page_rows = '15', bo_mobile_page_rows = '15', bo_new = '24', bo_hot = '100', bo_image_width = '600', bo_skin = 'gallery', bo_mobile_skin = 'gallery', bo_include_head = '_head.php', bo_include_tail = '_tail.php', bo_content_head = '', bo_content_tail = '', bo_mobile_content_head = '', bo_mobile_content_tail = '', bo_insert_content = '', bo_gallery_cols = '4', bo_gallery_width = '174', bo_gallery_height = '124', bo_mobile_gallery_width = '125', bo_mobile_gallery_height= '100', bo_upload_count = '2', bo_upload_size = '1048576', bo_reply_order = '1', bo_use_search = '1', bo_order = '', bo_write_min = '', bo_write_max = '', bo_comment_min = '', bo_comment_max = '', bo_sort_field = '', bo_1_subj = '', bo_2_subj = '', bo_3_subj = '', bo_4_subj = '', bo_5_subj = '', bo_6_subj = '', bo_7_subj = '', bo_8_subj = '', bo_9_subj = '', bo_10_subj = '', bo_1 = '', bo_2 = '', bo_3 = '', bo_4 = '', bo_5 = '', bo_6 = '', bo_7 = '', bo_8 = '', bo_9 = '', bo_10 = '' ", true, $dblink);

        // 게시판 테이블 생성
        $file = file('../adm/sql_write.sql');
        $sql = implode($file, "\n");

        $create_table = $write_prefix . "gallery{$i}0{$j}0";
        ...
        //소컨텐츠등록
        sql_query(" insert into `{$table_prefix}content` set co_id = 'sub{$i}0{$j}0', gr_id = 'group{$i}0', co_html = '1', co_subject = '서브{$i}0{$j}0', co_content= '<p align=center><b>내용을 입력하십시오.</b></p>' ", true, $dblink);
...
fwrite($f, "\$g5['banner_table'] = G5_TABLE_PREFIX.'banner'; // 배너관리 테이블\n");
fwrite($f, "?>");
...
?>
    ...
    <p>축하합니다. <?php echo $site_name ?> 설치가 완료되었습니다.</p>
...
<div class="ins_inner">
    ...
    <div class="inner_btn">
        <a href="http://<?=$site_domain?>/index.php" target="_blank"><?=$site_name?>로 이동</a>
    </div>
