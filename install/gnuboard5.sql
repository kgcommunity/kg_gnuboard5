...
CREATE TABLE IF NOT EXISTS `g5_banner` (
  ...
  `bn_textcolor` varchar(255) NOT NULL DEFAULT '',
  `bn_skin` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`bn_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_board` (
  ...
  `bo_use` tinyint(4) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `g5_content` (
  ...
  `co_use` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`co_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
